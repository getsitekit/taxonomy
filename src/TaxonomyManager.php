...
namespace Sitekit\Taxonomy;

use Sitekit\Application;
use Sitekit\Application\Exception;
...
class TaxonomyManager {
     ...
     */
    protected $types = [
        'single' => 'Sitekit\\Taxonomy\\Single',
        'hierarchical' => 'Sitekit\\Taxonomy\\Hierarchical',
    ];
