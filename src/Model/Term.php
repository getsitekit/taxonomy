...
use Sitekit\Taxonomy\TaxonomyBase;
...
use Sitekit\System\Model\DataModelTrait;
use Sitekit\System\Model\NodeInterface;
use Sitekit\System\Model\NodeTrait;
...
class Term implements NodeInterface, \JsonSerializable
{
    ...
    public static function getStatuses () {
        return [
            self::STATUS_PUBLISHED => __('taxonomy.status.published'),
            self::STATUS_UNPUBLISHED => __('taxonomy.status.unpublished')
        ];
    }
    ...
    public function getStatusText () {
        ...
        return isset($statuses[$this->status]) ? $statuses[$this->status] : __('taxonomy.status.unknown');
    }
